...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='owner',
            constraint=models.UniqueConstraint(django.db.models.functions.text.Lower('name'), django.db.models.expressions.F('db_id'), name='unique_lower_name_owner_db_id'),
        ),
        migrations.AddField(
        ...
        migrations.AddConstraint(
            model_name='category',
            constraint=models.UniqueConstraint(django.db.models.functions.text.Lower('name'), django.db.models.expressions.F('db_id'), name='unique_lower_name_category_db_id'),
        ),
        migrations.AddConstraint(
            model_name='db',
